...
| 5 | **License?** MIT vs Apache 2.0 vs proprietary. | Resolved | **Decided: GNU AGPL-3.0** (OSI-approved open source). Free to use, modify, and distribute, including commercially; copyleft + network clause require derivative works and hosted services to publish their source under AGPL-3.0. (Previously PolyForm Noncommercial; relicensed to be genuinely open source.) |
