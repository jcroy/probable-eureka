...
| 5 | **License?** MIT vs Apache 2.0 vs proprietary. | Resolved | **Decided: PolyForm Noncommercial License 1.0.0** (source-available). Free for any noncommercial use; commercial use requires a separate license (contact jcroy2828@gmail.com). |
